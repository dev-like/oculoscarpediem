                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="form-group col-md-8">
                          ...
                          <input type="file" name="caminho" id="caminho" class="filestyle" data-buttonText="Carregar" data-placeholder="Resolução ideal 2944 x 600  " data-btnClass="btn-light" required>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          {{ Form::label('titulo', 'Título do Banner') }}
