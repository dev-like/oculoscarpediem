...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{url('/')}}/assets/css/estilosNRA.css">
        		...
        		@foreach ($parceiross as $imagem)
            		...
            		@if ($imagem->produtos_id == $parceiroo->produtos_id)
                		...
                		<div class="slide fade a{{ $nume1 }}">
                			...
                			<div class="textoSlide">Slide {{ $nume3++ }}</div>
                		</div>
...
<div class="item-img">
<?php $count=0; $id_img=1; ?>
<section class="carrossel_NRA">
@foreach ($parceiross as $imagem)
@if ($imagem->produtos_id == $parceiroo->produtos_id)
<div class="imagens_prod">
<img src="uploads/produtos/{{$imagem->imagem}}" alt="Imagem {{ $id_img++ }}">
</div>
@endif
@endforeach
</section>
...
<!-- FIM --> <!-- ---------------------------------------------------------------------------------------- -->
  ...
  document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    ...
    <script type="text/javascript" src="{{url('/')}}/assets/css/scriptsNRA.js"></script>
